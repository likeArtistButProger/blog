...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "likeArtistButProger.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "likeArtistButProger.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
	...
	0xd5, 0xc7, 0x62, 0xb2, 0x3e, 0x38, 0x74, 0x2b, 0x20, 0x54, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12,
	0x1b, 0x38, 0xa0, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xcc, 0xdc, 0x4a, 0x80, 0x79, 0x01,
	0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/likeArtistButProger.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/likeArtistButProger.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "likeArtistButProger.blog.blog.Msg",
