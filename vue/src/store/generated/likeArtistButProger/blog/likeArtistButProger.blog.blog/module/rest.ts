...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/likeArtistButProger/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/likeArtistButProger/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/likeArtistButProger/blog/blog/posts
   */
  queryPosts = (
    query?: {
    ...
    this.request<BlogQueryPostsResponse, RpcStatus>({
      path: `/likeArtistButProger/blog/blog/posts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
