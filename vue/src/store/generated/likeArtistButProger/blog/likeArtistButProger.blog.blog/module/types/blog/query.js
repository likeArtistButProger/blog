...
export const protobufPackage = "likeArtistButProger.blog.blog";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("likeArtistButProger.blog.blog.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Posts(request) {
        const data = QueryPostsRequest.encode(request).finish();
        const promise = this.rpc.request("likeArtistButProger.blog.blog.Query", "Posts", data);
